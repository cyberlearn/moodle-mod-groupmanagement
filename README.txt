...
2. create a groupmanagement activity and select groups which users can chose from

See also
=========

Moodle plugins entry page :             http://moodle.org/plugins/view.php?plugin=mod_groupmanagement
