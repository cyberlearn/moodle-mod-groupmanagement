...
$string['groupmanagementclose'] = 'Chiusura';
$string['groupmanagement:deleteresponses'] = 'Cancellare risposte';
$string['groupmanagement:downloadresponses'] = 'Scaricare risposte';
$string['groupmanagementfull'] = 'Questo gruppo è già pieno';
$string['groupmanagement:choose'] = 'Memorizzare una scelta';
$string['groupmanagementname'] = 'Nome';
$string['groupmanagementopen'] = 'Apertura';
$string['groupmanagementoptions'] = 'Opzioni di scelta';
$string['groupmanagementoptions_help'] = 'Qui è dove bisogna specificare le scelte che gli studenti avranno a disposizione.
...
$string['limitmaxusersingroups_help'] = 'Questa opzione ti permette di limitare il numero di studenti che possono iscriversi ai gruppi. Quando il limite viene raggiunto poi nessun altro potrà isciversi.

Se i limiti sono disabilitati allora un numero illimitato di studenti potranno iscriversi.';
$string['groupmanagement:addinstance'] = 'Aggiungi una nuova attività di Scelta del gruppo';
$string['groupmanagement:readresponses'] = 'Leggi le risposte';
$string['groupmanagementsaved'] = 'La tua scelta è stata salvata';
$string['choicetext'] = 'Testo della scelta';
$string['chooseaction'] = 'Scegli un\'azione ...';
$string['choosegroup'] = 'Scegli un gruppo';
$string['limit'] = 'Limite';
$string['limitmaxusersingroups'] = 'Limita il numero di risposte possibili';
...
$string['groupdoesntexist'] = 'Parte dei gruppi specificati non esistono nel corso. Il docente dovrebbe creare i gruppi necessari e/o modificare questa attività.';
$string['samegroupused'] = 'Non si può selezionare più volte lo stesso gruppo.';
