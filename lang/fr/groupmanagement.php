...
$string['choice'] = 'Choix';
$string['groupmanagementclose'] = 'Jusqu\'à';
$string['groupmanagement:deleteresponses'] = 'Supprimer les réponses';
$string['groupmanagement:downloadresponses'] = 'Télécharger les réponses';
$string['groupmanagementfull'] = 'Ce choix est complet et il n\'y a plus de places disponibles.';
$string['groupmanagement:choose'] = 'Enregistrer un choix';
$string['groupmanagementname'] = 'Nom du choix de groupe';
$string['groupmanagementopen'] = 'Ouvert';
$string['groupmanagementoptions'] = 'Options des choix';
...
$string['groupmanagement:readresponses'] = 'Lire les réponses';
$string['groupmanagementsaved'] = 'Votre choix a été enregistré';
...
$string['modulename'] = 'Gestion de Groupe';
$string['modulename_help'] = 'Le module "Gestion de Groupe" permet à l\'enseignant de laisser l\'étudiant créer et/ou choisir un groupe. L\'enseignants peut choisir ce que peuvent faire les étudiants ainsi que les détails disponibles lors de la description des groupes.';
